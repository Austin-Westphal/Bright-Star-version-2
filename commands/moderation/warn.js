...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if(!message.member.hasPermission("MANAGE_MESSAGES")) {
      return message.channel.send("You should have Manage Messages Permissions to use this command!")
    }
    ...
    if(user.id === message.guild.owner.id) {
      return message.channel.send("Ya Donut, how you can warn server owner -_-")
    }
