...
module.exports = {
        ...
        alias: [],
        category: "economy",
        description: "Sell your item(s)",
        usage: "sell [mention | ID] <amount>",
    ...
    run: async (bot, message, args) => {
        ...
        if (args.join(' ').toLocaleLowerCase() == 'nikes') {
            ...
            let sembed3 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`✅ Sold a Mansion For 250000 Coins`);

            db.add(`money_${user.id}`, 250000)
            message.channel.send(sembed3)
        } else if (args.join(' ').toLocaleLowerCase() == 'soda') {
            let sembed2 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`❌ You don't have a soda to sell`);
            ...
            let sembed3 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`✅ Sold a soda For 50 Coins`);
